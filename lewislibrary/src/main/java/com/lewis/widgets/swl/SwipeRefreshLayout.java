...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
  ...
  /*  *//**
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        float rotation = (0.5F * adjustedPercent + tensionPercent);
        //Log.e("哈哈哈", adjustedPercent + "---" + tensionPercent + "---" + rotation);
        /*lewis 调整水面的高度*/
        mCircleView.setWaterLevelRatio((float) (adjustedPercent - 0.4 + tensionPercent * 0.6));
