...
public class DemoHelper {
    ...
    private EMOptions initChatOptions() {
        ...
        options.setMipushConfig("2882303761517675209", "5201767591209");
                ...
                if (message.getType() == EMMessage.Type.TXT) {
                    try {
                        if (message.ext() != null && message.getIntAttribute("type", -1) != -1) {
                            ...
                            Logger.e(id + "-" + type);
                            Intent intent = GoToUtils.messageToIntent(appContext, id, type);
                            if (intent != null) {
                                return intent;
                            }
                        }
    ...
    class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        public void onUserRemoved(String groupId, String groupName) {
            ...
            broadcastManager.sendBroadcast(new Intent(Constant.ACTION_GROUP_CHANAGED));
            Log.d(TAG,"current user removed, groupId:" + groupId);
        }
        ...
        public void onGroupDestroyed(String groupId, String groupName) {
            // group is dismissed,
            broadcastManager.sendBroadcast(new Intent(Constant.ACTION_GROUP_CHANAGED));
            Log.d(TAG,"group destroyed, groupId:" + groupId);
        }
        ...
        public void onRequestToJoinAccepted(String groupId, String groupName, String accepter) {
            ...
            Log.d(TAG,"request to join accepted, groupId:" + groupId);
        ...
        public void onRequestToJoinDeclined(String groupId, String groupName, String decliner, String reason) {
            ...
            Log.d(TAG,"request to join declined, groupId:" + groupId);
        }
...
//                break;
    ...
    public int getCountNotice() {
        int adminCount = 0;
        for (EMConversation conversation : EMClient.getInstance().chatManager().getAllConversations().values()) {
            if (conversation.conversationId().equals(Constants.ADMIN_ID)) {
    ...
    public void logout(boolean unbindDeviceToken, final EMCallBack callback) {
        ...
        EMClient.getInstance().logout(unbindDeviceToken, new EMCallBack() {
            ...
            public void onSuccess() {
                ...
                reset();
                EventBus.getDefault().post(new EventRefresh(EventRefresh.ACTION_LOGOUT));
                if (callback != null) {
                    callback.onSuccess();
                }
