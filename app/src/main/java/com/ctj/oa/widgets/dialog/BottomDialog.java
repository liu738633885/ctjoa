    ...
    public void setContentView(int layoutResID, boolean isfull, final boolean isAnimator) {
        ...
        try {
            ...
            if (isAnimator) {
                ...
                animator = ValueAnimator.ofFloat(0f, 0.15f);
                ...
                animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ...
                        Log.e("哈哈哈", t + "");
                        if (restart) {
                            viewContent.setScaleX(0.85f + t);
                            viewContent.setScaleY(0.85f + t);
                        } else {
                            viewContent.setScaleX(1.0f - t);
                            viewContent.setScaleY(1.0f - t);
                        }
                    }
                });
            }
